...
public class CTRF313_AjoutePlusieursCommentaires {
	...
	public static void test(WebDriver driver) throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[1]/div[13]/textarea")).sendKeys("$&_b");
		...
		driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[1]/div[13]/div[3]/button")).click();
		driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[1]/div[13]/textarea")).sendKeys("bonjour");
		...
		WebElement increment2 = driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[1]/div[13]/div[1]"));
		assertEquals(increment2.getText(),"Commentaires (2)");
		WebElement elementnondate2 = driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[1]/div[13]/div[3]/div[1]"));
		assertEquals(elementnondate2.getText(),"duzahfiuazh, le "+sdf.format(date));
		WebElement text2 = driver.findElement(By.xpath("//*[@id=\"root\"]/div/div[1]/div[13]/div[3]/div[2]"));
